...
npx ai-agent-skills install borghei/Claude-Skills/engineering-team

# Install to Claude Code only
npx ai-agent-skills install borghei/Claude-Skills/engineering-team --agent claude

# Install to Cursor only
npx ai-agent-skills install borghei/Claude-Skills/engineering-team --agent cursor
```
...
```bash
# Core Engineering
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-architect
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-frontend
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-backend
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-fullstack
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-qa
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-devops
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-secops
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/code-reviewer
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-security

# Cloud & Enterprise
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/aws-solution-architect
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/ms365-tenant-manager

# Development Tools
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/tdd-guide
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/tech-stack-evaluator

# AI/ML/Data
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-data-scientist
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-data-engineer
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-ml-engineer
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-prompt-engineer
npx ai-agent-skills install borghei/Claude-Skills/engineering-team/senior-computer-vision
```
