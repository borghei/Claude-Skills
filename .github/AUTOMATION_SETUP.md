...
1. Go to: https://github.com/borghei/Claude-Skills/settings/secrets/actions
...
```bash
# Status Labels (6)
gh label create "status: triage" --color "fbca04" --description "To Triage column" --repo borghei/Claude-Skills
gh label create "status: backlog" --color "d4c5f9" --description "Backlog column" --repo borghei/Claude-Skills
gh label create "status: ready" --color "0e8a16" --description "Ready column" --repo borghei/Claude-Skills
gh label create "status: in-progress" --color "1d76db" --description "In Progress column" --repo borghei/Claude-Skills
gh label create "status: in-review" --color "d876e3" --description "In Review column" --repo borghei/Claude-Skills
gh label create "status: done" --color "2ea44f" --description "Done column" --repo borghei/Claude-Skills

# Priority Labels (4)
gh label create "P0" --color "b60205" --description "Critical priority" --repo borghei/Claude-Skills
gh label create "P1" --color "d93f0b" --description "High priority" --repo borghei/Claude-Skills
gh label create "P2" --color "fbca04" --description "Medium priority" --repo borghei/Claude-Skills
gh label create "P3" --color "0e8a16" --description "Low priority" --repo borghei/Claude-Skills
...
1. Go to: https://github.com/users/borghei/projects/9
...
gh issue edit ISSUE_NUMBER --add-label "status: in-progress" --repo borghei/Claude-Skills
```
...
**Check:**
```bash
gh secret list --repo borghei/Claude-Skills | grep PROJECTS_TOKEN
```
...
**Check:**
```bash
gh run list --workflow=claude-code-review.yml --limit 5 --repo borghei/Claude-Skills
```
...
```bash
# Check failed runs
gh run list --status failure --limit 10 --repo borghei/Claude-Skills

# Verify secrets valid
gh secret list --repo borghei/Claude-Skills
```
...
- Factory reference: https://github.com/borghei/claude-code-skills-factory
