...
Complete installation guide for all 343 production-ready skills across 17 domains, 786 Python tools, 76 agents, 26 slash commands, 21 compound sub-skills, 18 compliance frameworks and 8 CI/CD workflows. Works with Claude Code, Claude.ai, Cursor, Copilot, Codex, Gemini CLI, Windsurf, Cline, Aider, Goose, ChatGPT and more.
...
```bash
# List all 343 skills across 17 domains
python scripts/skill-installer.py list
...
**Skills Version:** 4.11.0 (343 production skills, 786 Python tools, 76 agents, 26 slash commands, 21 compound sub-skills, 8 CI/CD workflows)
