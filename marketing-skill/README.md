...
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill

# Install to Claude Code only
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill --agent claude

# Install to Cursor only
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill --agent cursor
```
...
```bash
# Content Creator
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/content-creator

# Demand Generation & Acquisition
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/marketing-demand-acquisition

# Product Marketing Strategy
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/marketing-strategy-pmm

# App Store Optimization
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/app-store-optimization

# Social Media Analyzer
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/social-media-analyzer

# Campaign Analytics
npx ai-agent-skills install borghei/Claude-Skills/marketing-skill/campaign-analytics
```
